...
import com.mobiliario.dto.recovery.PasswordRecovery;
import com.mobiliario.models.UserEntity;
import com.mobiliario.respositories.UserRepository;
import com.mobiliario.service.email.IEmailService;
...
public class RecoveryController {
    ...
    public ResponseEntity<?> recoverPassword(@PathVariable String data) throws UnknownHostException {
        ...
        if(user!=null){
            ...
            emailService.sendEmail(email,"Recuperacion de password","Vamo a recuperar" +
                    "la contraseña: " +"http://"+ip.getHostAddress()+":5173/recovery?param="+ code + "&param2="+user.getUsername());
